...
const состояние = {
  карта: [], // массив строк
  знак: '#',
  инструмент: 'кисть', // кисть | ластик | мышь
  масштаб: 0.6,
...
window.addEventListener('keydown', (e) => {
  ...
  if (e.ctrlKey || e.metaKey) {
    const клавиша = e.key.toLowerCase();
    const дела = {
      z: отменить,
      y: вернуть,
      a: выделитьВсё,
...
function выбрать(ключ) {
  состояние.инструмент = ключ === МЫШЬ ? 'мышь' : ключ === ПУСТО ? 'ластик' : 'кисть';
  ...
  const имя =
    ключ === МЫШЬ ? 'Выделение' : ключ === ПУСТО ? 'Ластик' : ЗНАКИ.get(ключ)?.имя ?? ключ;
